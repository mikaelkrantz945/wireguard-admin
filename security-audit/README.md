...
| 3 | [XSS audit (admin.html)](findings/03-portal-xss.md) | **Fixing** | Critical |
...
| 7 | [Weak password hashing](findings/07-weak-password-hashing.md) | **Fixing** | Critical |
...
| 10 | [ACL enforcement state drift](findings/10-acl-enforcement-drift.md) | Analyzed | Critical |
| 11 | [2FA multi-interface bugs](findings/11-2fa-multi-interface.md) | Analyzed | High |
